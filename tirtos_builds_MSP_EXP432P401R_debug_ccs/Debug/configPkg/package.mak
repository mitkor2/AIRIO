...
.dlls,em4f .dlls: debug.pem4f

-include package/cfg/debug_pem4f.mak
-include package/cfg/debug_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/debug_pem4f.dep
endif
debug.pem4f: package/cfg/debug_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
debug.pem4f package/cfg/debug_pem4f.c: .libraries,em4f
endif

package/cfg/debug_pem4f.c package/cfg/debug_pem4f.h package/cfg/debug_pem4f.xdl: override _PROG_NAME := debug.xem4f
package/cfg/debug_pem4f.c: package/cfg/debug_pem4f.cfg
package/cfg/debug_pem4f.xdc.inc: package/cfg/debug_pem4f.xdl
package/cfg/debug_pem4f.xdl package/cfg/debug_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/debug_pem4f.cfg
	-$(RM) package/cfg/debug_pem4f.dep
	-$(RM) package/cfg/debug_pem4f.c
	-$(RM) package/cfg/debug_pem4f.xdc.inc

clean,em4f::
	-$(RM) debug.pem4f
.executables,em4f .executables: debug.xem4f

debug.xem4f: |debug.pem4f

-include package/cfg/debug.xem4f.mak
debug.xem4f: package/cfg/debug_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/debug_pem4f.oem4f   package/cfg/debug_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
debug.xem4f: export C_DIR=
debug.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
debug.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

debug.test test,em4f test: debug.xem4f.test

debug.xem4f.test:: debug.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 debug.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.debug.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,debug.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
debug_pem4f.oem4f,copy : package/cfg/debug_pem4f.oem4f
debug_pem4f.sem4f,copy : package/cfg/debug_pem4f.sem4f
